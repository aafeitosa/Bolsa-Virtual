...
public class GridLazyLoaderDTO {
	...
	@Override
	public GridLazyLoaderDTO clone() {
		return new GridLazyLoaderDTO(first, pageSize, sortField, sortOrder, new GridLazyLoaderFilter(filters));
	}

	public GridLazyLoaderFilter getGridFilter() {

		if (!GridLazyLoaderFilter.class.isAssignableFrom(filters.getClass())) {
			throw new IllegalArgumentException("Is not com.gkn.supplierweb.ui.components.GridLazyLoaderFilter!");
		}

		return (GridLazyLoaderFilter) filters;
